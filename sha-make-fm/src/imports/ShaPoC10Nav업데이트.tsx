import svgPaths from "./svg-fodi3oah1h";
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[115.234px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[115.234px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#4a5565] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">2025.11.23 기준</p>
      </div>
    </div>
  );
}
...
function Heading2() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 3">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#6a7282] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">현재 기준가 (전일)</p>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="absolute h-[48px] left-0 top-0 w-[193.594px]" data-name="Text">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[48px] left-0 not-italic text-[#00a63e] text-[48px] text-nowrap top-[0.5px] whitespace-pre">1,023.20</p>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="absolute h-[28px] left-[205.59px] top-[20px] w-[40.336px]" data-name="Text">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[28px] left-0 not-italic text-[#4a5565] text-[20px] text-nowrap top-0 whitespace-pre">원</p>
    </div>
  );
}
...
function Heading3() {
  return (
    <div className="h-[24px] relative shrink-0 w-full" data-name="Heading 4">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[74px] not-italic text-[#6a7282] text-[16px] text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">전일 수익률</p>
    </div>
  );
}
...
function Text5() {
  return (
    <div className="content-stretch flex h-[36px] items-start relative shrink-0 w-full" data-name="Text">
      <p className="font-['Pretendard_GOV:SemiBold',sans-serif] leading-[36px] not-italic relative shrink-0 text-[#00a63e] text-[30px] text-nowrap text-right whitespace-pre">+0.05%</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-[101px] not-italic text-[#6a7282] text-[14px] text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">2025.11.22 기준</p>
    </div>
  );
}
...
function Heading4() {
  return (
    <div className="h-[37px] relative shrink-0 w-full" data-name="Heading 3">
      <div aria-hidden="true" className="absolute border-[0px_0px_1px] border-gray-200 border-solid inset-0 pointer-events-none" />
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[24px] left-0 not-italic text-[#1e2939] text-[18px] text-nowrap top-[-0.5px] whitespace-pre">금일 NAV 계산 (2025.11.23)</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[150.828px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[150.828px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#1e2939] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">총 자산 (Total Assets)</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[138.281px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[138.281px]">
        <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[24px] left-[139.28px] not-italic text-[#101828] text-[18px] text-right top-[-0.5px] translate-x-[-100%] w-[208px]">806,458,320,000 원</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[27.656px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[27.656px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#4a5565] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">채권</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 grow h-[20px] min-h-px min-w-px relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-full">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#6a7282] text-[14px] top-[-0.5px] w-[49px]">(93.0%)</p>
      </div>
    </div>
  );
}
...
function Text10() {
  return (
    <div className="h-[24px] relative shrink-0 w-[138.281px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[138.281px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[139.28px] not-italic text-[#101828] text-[16px] text-right top-[-0.5px] translate-x-[-100%] w-[171px]">750,000,000,000 원</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 grow h-[24px] min-h-px min-w-px relative shrink-0" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-full">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#4a5565] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">유동성 자산</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[40.773px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[40.773px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#6a7282] text-[14px] top-[-0.5px] w-[41px]">(7.0%)</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[129.063px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[129.063px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[130.06px] not-italic text-[#101828] text-[16px] text-right top-[-0.5px] translate-x-[-100%] w-[160px]">56,458,320,000 원</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[170.25px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[170.25px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#1e2939] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">총 부채 (Total Liabilities)</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[113.031px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[113.031px]">
        <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[24px] left-[114px] not-italic text-[#e7000b] text-[16px] text-right top-[-0.5px] translate-x-[-100%] w-[114px]">-0 원</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[200.875px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[200.875px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#101828] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">순자산총액 (Net Asset Value)</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[28px] relative shrink-0 w-[172.859px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[28px] relative w-[172.859px]">
        <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[28px] left-[172.86px] not-italic text-[#00a63e] text-[20px] text-right top-[0.5px] translate-x-[-100%] w-[205px]">806,000,000,000 원</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[139.031px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[139.031px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#1e2939] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">총 좌수 (Total Units)</p>
      </div>
    </div>
  );
}
...
function Text19() {
  return (
    <div className="h-[24px] relative shrink-0 w-[138.281px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[138.281px]">
        <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[24px] left-[139.28px] not-italic text-[#101828] text-[18px] text-right top-[-0.5px] translate-x-[-100%] w-[214px]">788,012,345,678 좌</p>
      </div>
    </div>
  );
}
...
function Frame() {
  return (
    <div className="content-stretch flex font-['Pretendard_GOV:SemiBold',sans-serif] gap-[8px] items-end not-italic relative shrink-0 text-center text-nowrap text-white whitespace-pre">
      ...
      <p className="leading-[normal] relative shrink-0 text-[16px]">원/좌</p>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex items-center justify-between relative w-full">
        <p className="font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-green-100 text-nowrap whitespace-pre">금일 기준가 (09:00 적용)</p>
        <Frame />
      </div>
    </div>
  );
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[147.5px]" data-name="Heading 3">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[147.5px]">
        <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[24px] left-0 not-italic text-[#364153] text-[18px] text-nowrap top-[-0.5px] whitespace-pre">블록체인 업데이트 정보</p>
      </div>
    </div>
  );
}
...
function Container20() {
  return (
    <div className="h-[20px] relative shrink-0 w-full" data-name="Container">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[-0.5px] whitespace-pre">스마트 컨트랙트 함수</p>
    </div>
  );
}
...
function Frame6() {
  return (
    <div className="absolute content-stretch flex gap-[8px] items-center left-[-36px] top-0">
      <Icon1 />
      <p className="font-['Pretendard_GOV:Medium',sans-serif] leading-[28px] not-italic relative shrink-0 text-[18px] text-center text-nowrap text-white whitespace-pre">09:00 NAV 블록체인 등록</p>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[63.93px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[63.93px]">
        <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[24px] left-[32.5px] not-italic text-[16px] text-center text-nowrap text-white top-[-0.5px] translate-x-[-50%] whitespace-pre">NAV 관리</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[92.188px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[92.188px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[46.5px] not-italic text-[#d1d5dc] text-[16px] text-center text-nowrap top-[-0.5px] translate-x-[-50%] whitespace-pre">토큰 발행 관리</p>
      </div>
    </div>
  );
}
...
export default function ShaPoC10Nav() {
  return (
