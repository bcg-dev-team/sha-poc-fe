import svgPaths from "./svg-5z933dgoz9";

function Heading() {
  return (
    <div className="h-[36px] relative shrink-0 w-full" data-name="Heading 1">
      <p className="absolute font-['Pretendard_GOV:Bold',sans-serif] leading-[36px] left-0 not-italic text-[#101828] text-[24px] text-nowrap top-[-0.5px] whitespace-pre">환매 관리</p>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="h-[24px] relative shrink-0 w-[160.938px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[160.938px]">
...
function Container() {
  return (
    <div className="h-[30px] relative shrink-0 w-[361.18px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex gap-[8px] h-[30px] items-center relative w-[361.18px]">
        <Text />
        <Text1 />
        <Text2 />
      </div>
...
function Container1() {
  return (
    <div className="bg-blue-50 h-full relative rounded-[10px] shrink-0 w-[133.391px]" data-name="Container">
      <div aria-hidden="true" className="absolute border border-[#bedbff] border-solid inset-0 pointer-events-none rounded-[10px]" />
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border content-stretch flex flex-col h-full items-start px-[17px] py-[10px] relative w-[133.391px]">
        <Text3 />
      </div>
    </div>
  );
...
function Heading2() {
  return (
    <div className="absolute border-[0px_0px_1px] border-gray-100 border-solid h-[33px] left-[24px] top-[24px] w-[392.664px]" data-name="Heading 3">
      <p className="absolute font-['Pretendard_GOV:Bold',sans-serif] leading-[24px] left-0 not-italic text-[#6a7282] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">금일 환매 건수</p>
    </div>
  );
}
...
function Text4() {
  return (
    <div className="absolute h-[54px] left-0 top-0 w-[41.484px]" data-name="Text">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[54px] left-0 not-italic text-[#fc8815] text-[36px] text-nowrap top-[-0.5px] whitespace-pre">38</p>
    </div>
  );
}
...
function Text6() {
  return (
    <div className="absolute h-[22.5px] left-[32px] top-[4px] w-[104.617px]" data-name="Text">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[22.5px] left-0 not-italic text-[#e7000b] text-[15px] top-[-1px] w-[105px]">+5 건 (전일 대비)</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="absolute bg-red-50 h-[30.5px] left-[24px] rounded-[1.67772e+07px] top-[139px] w-[148.617px]" data-name="Container">
      <Icon />
      <Text6 />
    </div>
  );
...
function Heading3() {
  return (
    <div className="absolute border-[0px_0px_1px] border-gray-100 border-solid h-[33px] left-[24px] top-[24px] w-[392.664px]" data-name="Heading 3">
      <p className="absolute font-['Pretendard_GOV:Bold',sans-serif] leading-[24px] left-0 not-italic text-[#6a7282] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">금일 환매 금액</p>
    </div>
  );
}
...
function Text7() {
  return (
    <div className="absolute h-[54px] left-0 top-0 w-[259.281px]" data-name="Text">
      <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[54px] left-0 not-italic text-[#fc8815] text-[36px] text-nowrap top-[-0.5px] whitespace-pre">38,085,362,849</p>
    </div>
  );
}
...
function Text9() {
  return (
    <div className="absolute h-[22.5px] left-[32px] top-[4px] w-[195.367px]" data-name="Text">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[22.5px] left-0 not-italic text-[#e7000b] text-[15px] top-[-1px] w-[196px]">+6,200,000,000 원 (전일 대비)</p>
    </div>
  );
}
...
function Container7() {
  return (
    <div className="absolute bg-red-50 h-[30.5px] left-[24px] rounded-[1.67772e+07px] top-[139px] w-[239.367px]" data-name="Container">
      <Icon1 />
      <Text9 />
    </div>
  );
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[59.922px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[59.922px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#4a5565] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">소각 완료</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[32.266px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[32.266px]">
        <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[33px] not-italic text-[#4a5565] text-[16px] text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">32 건</p>
      </div>
    </div>
  );
}
...
function Text12() {
  return (
    <div className="h-[24px] relative shrink-0 w-[59.922px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[59.922px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#4a5565] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">소각 대기</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[24px] relative shrink-0 w-[23.047px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[23.047px]">
        <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[24px] not-italic text-[#fc8815] text-[16px] text-nowrap text-right top-[-0.5px] translate-x-[-100%] whitespace-pre">6 건</p>
      </div>
    </div>
  );
}
...
function Text14() {
  return (
    <div className="h-[24px] relative shrink-0 w-[59.922px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[59.922px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#4a5565] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">지급 완료</p>
      </div>
    </div>
  );
}
  ...
  return (
    <div className="basis-0 bg-gray-50 grow h-[46px] min-h-px min-w-px relative rounded-[10px] shrink-0" data-name="Button">
      ...
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[46px] relative w-full">
        <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[55px] not-italic text-[#364153] text-[16px] text-center text-nowrap top-[10.5px] translate-x-[-50%] whitespace-pre">소각 대기</p>
      </div>
    </div>
  );
}
...
function HeaderCell() {
  return (
    <div className="absolute h-[57px] left-0 top-0 w-[308.938px]" data-name="Header Cell">
...
function HeaderCell1() {
  return (
    <div className="absolute h-[57px] left-[308.94px] top-0 w-[175.773px]" data-name="Header Cell">
...
function HeaderCell2() {
  return (
    <div className="absolute h-[57px] left-[484.71px] top-0 w-[198.75px]" data-name="Header Cell">
...
function HeaderCell3() {
  return (
    <div className="absolute h-[57px] left-[683.46px] top-0 w-[264.008px]" data-name="Header Cell">
      <p className="absolute font-['Pretendard_GOV:Bold',sans-serif] leading-[24px] left-[240.7px] not-italic text-[#1e2939] text-[16px] text-nowrap text-right top-[15.5px] translate-x-[-100%] whitespace-pre">환매금액</p>
    </div>
  );
}
...
function HeaderCell4() {
  return (
    <div className="absolute h-[57px] left-[947.47px] top-0 w-[264.008px]" data-name="Header Cell">
      <p className="absolute font-['Pretendard_GOV:Bold',sans-serif] leading-[24px] left-[240.65px] not-italic text-[#1e2939] text-[16px] text-nowrap text-right top-[15.5px] translate-x-[-100%] whitespace-pre">지급액(세후)</p>
    </div>
  );
}
...
function HeaderCell5() {
  return (
    <div className="absolute h-[57px] left-[1211.48px] top-0 w-[162.523px]" data-name="Header Cell">
      <p className="absolute font-['Pretendard_GOV:Bold',sans-serif] leading-[24px] left-[81.6px] not-italic text-[#1e2939] text-[16px] text-center text-nowrap top-[15.5px] translate-x-[-50%] whitespace-pre">소각상태</p>
    </div>
  );
}
...
function TableCell() {
  return (
    <div className="h-[58px] relative shrink-0 w-[308.938px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.75px] whitespace-pre">SHA20251123005S</p>
    </div>
  );
}
...
function TableCell1() {
  return (
    <div className="h-[58px] relative shrink-0 w-[175.773px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#364153] text-[16px] text-nowrap top-[16.75px] whitespace-pre">16:28:41</p>
    </div>
  );
}
...
function TableCell2() {
  return (
    <div className="h-[58px] relative shrink-0 w-[198.75px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.75px] whitespace-pre">김차산</p>
    </div>
  );
}
...
function TableCell3() {
  return (
    <div className="h-[58px] relative shrink-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.16px] not-italic text-[#fc8815] text-[16px] text-right top-[16.75px] translate-x-[-100%] w-[120px]">1,002,252,813원</p>
    </div>
  );
}
...
function TableCell4() {
  return (
    <div className="h-[58px] relative shrink-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.16px] not-italic text-[#00a63e] text-[16px] text-right top-[16.75px] translate-x-[-100%] w-[120px]">1,001,655,403원</p>
    </div>
  );
}
...
function Text16() {
  return (
    <div className="absolute bg-blue-100 box-border content-stretch flex gap-[10px] items-center justify-center left-[57.89px] px-[12px] py-[4px] rounded-[1.67772e+07px] top-[17.5px]" data-name="Text">
      <div aria-hidden="true" className="absolute border border-[#8ec5ff] border-solid inset-0 pointer-events-none rounded-[1.67772e+07px]" />
...
function TableCell5() {
  return (
    <div className="h-[58px] relative shrink-0 w-[162.523px]" data-name="Table Cell">
      <Text16 />
    </div>
  );
}
...
function TableCell6() {
  return (
    <div className="absolute h-[57.5px] left-0 top-0 w-[308.938px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">SHA20251123005A</p>
    </div>
  );
}
...
function TableCell7() {
  return (
    <div className="absolute h-[57.5px] left-[308.94px] top-0 w-[175.773px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#364153] text-[16px] text-nowrap top-[16.25px] whitespace-pre">16:15:22</p>
    </div>
  );
}
...
function TableCell8() {
  return (
    <div className="absolute h-[57.5px] left-[484.71px] top-0 w-[198.75px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">이투자</p>
    </div>
  );
}
...
function TableCell9() {
  return (
    <div className="absolute h-[57.5px] left-[683.46px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.99px] not-italic text-[#fc8815] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[107px]">501,126,407원</p>
    </div>
  );
}
...
function TableCell10() {
  return (
    <div className="absolute h-[57.5px] left-[947.47px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.99px] not-italic text-[#00a63e] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[107px]">500,953,127원</p>
    </div>
  );
}
...
function Text17() {
  return (
    <div className="absolute bg-[#fef3c6] box-border content-stretch flex gap-[10px] items-center justify-center left-[57.89px] px-[12px] py-[4px] rounded-[1.67772e+07px] top-[17px]" data-name="Text">
      <div aria-hidden="true" className="absolute border border-[#ffd230] border-solid inset-0 pointer-events-none rounded-[1.67772e+07px]" />
...
function TableCell11() {
  return (
    <div className="absolute h-[57.5px] left-[1211.48px] top-0 w-[162.523px]" data-name="Table Cell">
      <Text17 />
    </div>
  );
}
...
function TableRow2() {
  return (
    <div className="absolute border-[0px_0px_1px] border-gray-200 border-solid h-[57.5px] left-0 top-[58px] w-[1374px]" data-name="Table Row">
      <TableCell6 />
      <TableCell7 />
      <TableCell8 />
      <TableCell9 />
...
function TableCell12() {
  return (
    <div className="absolute h-[57.5px] left-0 top-0 w-[308.938px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">SHA20251123005P</p>
    </div>
  );
}
...
function TableCell13() {
  return (
    <div className="absolute h-[57.5px] left-[308.94px] top-0 w-[175.773px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#364153] text-[16px] text-nowrap top-[16.25px] whitespace-pre">16:02:15</p>
    </div>
  );
}
...
function TableCell14() {
  return (
    <div className="absolute h-[57.5px] left-[484.71px] top-0 w-[198.75px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">박세무(법인)</p>
    </div>
  );
}
...
function TableCell15() {
  return (
    <div className="absolute h-[57.5px] left-[683.46px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.16px] not-italic text-[#fc8815] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[120px]">2,004,505,626원</p>
    </div>
  );
}
...
function TableCell16() {
  return (
    <div className="absolute h-[57.5px] left-[947.47px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.16px] not-italic text-[#00a63e] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[120px]">2,004,505,626원</p>
    </div>
  );
}
...
function Text18() {
  return (
    <div className="absolute bg-blue-100 box-border content-stretch flex gap-[10px] items-center justify-center left-[57.89px] px-[12px] py-[4px] rounded-[1.67772e+07px] top-[17px]" data-name="Text">
      <div aria-hidden="true" className="absolute border border-[#8ec5ff] border-solid inset-0 pointer-events-none rounded-[1.67772e+07px]" />
      <p className="font-['Pretendard_GOV:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#1447e6] text-[14px] text-center text-nowrap whitespace-pre">완료</p>
    </div>
  );
...
function TableRow3() {
  return (
    <div className="absolute border-[0px_0px_1px] border-gray-200 border-solid h-[57.5px] left-0 top-[115.5px] w-[1374px]" data-name="Table Row">
      <TableCell12 />
      <TableCell13 />
      <TableCell14 />
      <TableCell15 />
...
function TableCell18() {
  return (
    <div className="absolute h-[57.5px] left-0 top-0 w-[308.938px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">SHA20251123005Z</p>
    </div>
  );
}
...
function TableCell19() {
  return (
    <div className="absolute h-[57.5px] left-[308.94px] top-0 w-[175.773px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#364153] text-[16px] text-nowrap top-[16.25px] whitespace-pre">15:48:33</p>
    </div>
  );
}
...
function TableCell20() {
  return (
    <div className="absolute h-[57.5px] left-[484.71px] top-0 w-[198.75px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">최부자</p>
    </div>
  );
}
...
function TableCell21() {
  return (
    <div className="absolute h-[57.5px] left-[683.46px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.16px] not-italic text-[#fc8815] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[120px]">1,503,379,219원</p>
    </div>
  );
}
...
function TableCell22() {
  return (
    <div className="absolute h-[57.5px] left-[947.47px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.16px] not-italic text-[#00a63e] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[120px]">1,502,859,757원</p>
    </div>
  );
}
...
function TableRow4() {
  return (
    <div className="absolute border-[0px_0px_1px] border-gray-200 border-solid h-[57.5px] left-0 top-[173px] w-[1374px]" data-name="Table Row">
      <TableCell18 />
      <TableCell19 />
      <TableCell20 />
      <TableCell21 />
...
function TableCell24() {
  return (
    <div className="absolute h-[57.5px] left-0 top-0 w-[308.938px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">SHA20251123005I</p>
    </div>
  );
}
...
function TableCell25() {
  return (
    <div className="absolute h-[57.5px] left-[308.94px] top-0 w-[175.773px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#364153] text-[16px] text-nowrap top-[16.25px] whitespace-pre">15:32:07</p>
    </div>
  );
}
...
function TableCell26() {
  return (
    <div className="absolute h-[57.5px] left-[484.71px] top-0 w-[198.75px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">정금융</p>
    </div>
  );
}
...
function TableCell27() {
  return (
    <div className="absolute h-[57.5px] left-[683.46px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.99px] not-italic text-[#fc8815] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[107px]">300,675,844원</p>
    </div>
  );
}
...
function TableCell28() {
  return (
    <div className="absolute h-[57.5px] left-[947.47px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.99px] not-italic text-[#00a63e] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[107px]">300,571,951원</p>
    </div>
  );
}
...
function Text20() {
  return (
    <div className="absolute bg-[#fef3c6] box-border content-stretch flex gap-[10px] items-center justify-center left-[57.89px] px-[12px] py-[5px] rounded-[1.67772e+07px] top-[17px]" data-name="Text">
      <div aria-hidden="true" className="absolute border border-[#ffd230] border-solid inset-0 pointer-events-none rounded-[1.67772e+07px]" />
      <p className="font-['Pretendard_GOV:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#bb4d00] text-[14px] text-center text-nowrap whitespace-pre">대기</p>
    </div>
  );
...
function TableRow5() {
  return (
    <div className="absolute border-[0px_0px_1px] border-gray-200 border-solid h-[57.5px] left-0 top-[230.5px] w-[1374px]" data-name="Table Row">
      <TableCell24 />
      <TableCell25 />
      <TableCell26 />
      <TableCell27 />
...
function TableCell30() {
  return (
    <div className="absolute h-[57.5px] left-0 top-0 w-[308.938px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">SHA20251123005O</p>
    </div>
  );
}
...
function TableCell31() {
  return (
    <div className="absolute h-[57.5px] left-[308.94px] top-0 w-[175.773px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#364153] text-[16px] text-nowrap top-[16.25px] whitespace-pre">15:18:55</p>
    </div>
  );
}
...
function TableCell32() {
  return (
    <div className="absolute h-[57.5px] left-[484.71px] top-0 w-[198.75px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">강출자(법인)</p>
    </div>
  );
}
...
function TableCell33() {
  return (
    <div className="absolute h-[57.5px] left-[683.46px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.99px] not-italic text-[#fc8815] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[107px]">802,901,251원</p>
    </div>
  );
}
...
function TableCell34() {
  return (
    <div className="absolute h-[57.5px] left-[947.47px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.99px] not-italic text-[#00a63e] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[107px]">802,901,251원</p>
    </div>
  );
}
...
function Text21() {
  return (
    <div className="absolute bg-blue-100 box-border content-stretch flex gap-[10px] items-center justify-center left-[57.89px] px-[12px] py-[5px] rounded-[1.67772e+07px] top-[17px]" data-name="Text">
      <div aria-hidden="true" className="absolute border border-[#8ec5ff] border-solid inset-0 pointer-events-none rounded-[1.67772e+07px]" />
      <p className="font-['Pretendard_GOV:Regular',sans-serif] leading-[16px] not-italic relative shrink-0 text-[#1447e6] text-[14px] text-center text-nowrap whitespace-pre">완료</p>
    </div>
  );
...
function TableRow6() {
  return (
    <div className="absolute border-[0px_0px_1px] border-gray-200 border-solid h-[57.5px] left-0 top-[288px] w-[1374px]" data-name="Table Row">
      <TableCell30 />
      <TableCell31 />
      <TableCell32 />
      <TableCell33 />
...
function TableCell36() {
  return (
    <div className="absolute h-[57.5px] left-0 top-0 w-[308.938px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">SHA20251123004W</p>
    </div>
  );
}
...
function TableCell37() {
  return (
    <div className="absolute h-[57.5px] left-[308.94px] top-0 w-[175.773px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#364153] text-[16px] text-nowrap top-[16.25px] whitespace-pre">14:55:22</p>
    </div>
  );
}
...
function TableCell38() {
  return (
    <div className="absolute h-[57.5px] left-[484.71px] top-0 w-[198.75px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">오자산</p>
    </div>
  );
}
...
function TableCell39() {
  return (
    <div className="absolute h-[57.5px] left-[683.46px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.16px] not-italic text-[#fc8815] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[120px]">1,203,505,126원</p>
    </div>
  );
}
...
function TableCell40() {
  return (
    <div className="absolute h-[57.5px] left-[947.47px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.16px] not-italic text-[#00a63e] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[120px]">1,202,344,982원</p>
    </div>
  );
}
...
function TableRow7() {
  return (
    <div className="absolute border-[0px_0px_1px] border-gray-200 border-solid h-[57.5px] left-0 top-[345.5px] w-[1374px]" data-name="Table Row">
      <TableCell36 />
      <TableCell37 />
      <TableCell38 />
      <TableCell39 />
...
function TableCell42() {
  return (
    <div className="absolute h-[57px] left-0 top-0 w-[308.938px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">SHA20251123004M</p>
    </div>
  );
}
...
function TableCell43() {
  return (
    <div className="absolute h-[57px] left-[308.94px] top-0 w-[175.773px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#364153] text-[16px] text-nowrap top-[16.25px] whitespace-pre">14:32:18</p>
    </div>
  );
}
...
function TableCell44() {
  return (
    <div className="absolute h-[57px] left-[484.71px] top-0 w-[198.75px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-[24px] not-italic text-[#101828] text-[16px] text-nowrap top-[16.25px] whitespace-pre">송금융</p>
    </div>
  );
}
...
function TableCell45() {
  return (
    <div className="absolute h-[57px] left-[683.46px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.99px] not-italic text-[#fc8815] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[107px]">600,450,283원</p>
    </div>
  );
}
...
function TableCell46() {
  return (
    <div className="absolute h-[57px] left-[947.47px] top-0 w-[264.008px]" data-name="Table Cell">
      <p className="absolute font-['Pretendard_GOV:Medium',sans-serif] leading-[24px] left-[240.99px] not-italic text-[#00a63e] text-[16px] text-right top-[16.25px] translate-x-[-100%] w-[107px]">600,089,421원</p>
    </div>
  );
}
...
function TableCell47() {
  return (
    <div className="absolute h-[57px] left-[1211.48px] top-0 w-[162.523px]" data-name="Table Cell">
      <Text23 />
    </div>
  );
}
...
function TableRow8() {
  return (
    <div className="absolute h-[57px] left-0 top-[403px] w-[1374px]" data-name="Table Row">
      <TableCell42 />
      <TableCell43 />
      <TableCell44 />
      <TableCell45 />
...
function TableBody() {
  return (
    <div className="absolute h-[460px] left-0 top-[57px] w-[1374px]" data-name="Table Body">
      <TableRow1 />
      <TableRow2 />
      <TableRow3 />
      <TableRow4 />
...
function Table() {
  return (
    <div className="h-[517px] overflow-clip relative shrink-0 w-full" data-name="Table">
      <TableHeader />
      <TableBody />
    </div>
  );
...
function Text24() {
  return <div className="absolute h-[17px] left-[16.13px] top-[1.5px] w-[8.07px]" data-name="Text" />;
}
  ...
  return (
    <div className="h-[20px] relative shrink-0 w-[36.305px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[20px] relative w-[36.305px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[-0.5px] whitespace-pre">총</p>
        <Text24 />
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[20px] left-0 not-italic text-[#4a5565] text-[14px] text-nowrap top-[-0.5px] whitespace-pre">
          <span>{`총 `}</span>
...
function RedemptionTable() {
  return (
    <div className="bg-white h-[681px] relative rounded-[10px] shrink-0 w-full" data-name="RedemptionTable">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="box-border content-stretch flex flex-col h-[681px] items-start p-px relative w-full">
          <Container15 />
          <Table />
          <Container19 />
        </div>
...
function Text25() {
  return (
    <div className="h-[24px] relative shrink-0 w-[59.922px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[59.922px]">
        <p className="absolute font-['Pretendard_GOV:Regular',sans-serif] leading-[24px] left-0 not-italic text-[#d1d5dc] text-[16px] text-nowrap top-[-0.5px] whitespace-pre">청약 관리</p>
      </div>
    </div>
  );
}
...
function Text26() {
  return (
    <div className="h-[24px] relative shrink-0 w-[59.922px]" data-name="Text">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid box-border h-[24px] relative w-[59.922px]">
        <p className="absolute font-['Pretendard_GOV:SemiBold',sans-serif] leading-[24px] left-0 not-italic text-[16px] text-nowrap text-white top-[-0.5px] whitespace-pre">환매 관리</p>
      </div>
    </div>
  );
}
...
function Icon4() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_1_305)" id="Icon">
...
function Sidebar() {
  return (
    <div className="absolute bg-[#1e2939] h-[1283px] left-0 top-[64px] w-[256px]" data-name="Sidebar">
      <div className="box-border content-stretch flex flex-col h-[1283px] items-start overflow-clip pb-0 pl-[16px] pr-[17px] pt-[16px] relative rounded-[inherit] w-[256px]">
        <List />
      </div>
...
export default function ShaPoC() {
  return (
    <div className="bg-gray-100 relative size-full" data-name="SHA-PoC-08.환매관리">
      <App />
      <Sidebar />
      <Header />
    </div>
