  ...
  return (
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="space-y-[8px]">
          ...
          >
            <svg className="size-[20px]" fill="none" viewBox="0 0 20 20">
              <path d={svgPaths.p140c1100} stroke={currentPage === "subscription" ? "white" : "#D1D5DC"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
              <path d="M15 14.1667V7.5" stroke={currentPage === "subscription" ? "white" : "#D1D5DC"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
              <path d="M10.8333 14.1667V4.16667" stroke={currentPage === "subscription" ? "white" : "#D1D5DC"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
              <path d="M6.66667 14.1667V11.6667" stroke={currentPage === "subscription" ? "white" : "#D1D5DC"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
            </svg>
          ...
          >
            <svg className="size-[20px]" fill="none" viewBox="0 0 20 20">
              <path d={svgPaths.p3e8f800} stroke={currentPage === "redemption" ? "white" : "#D1D5DC"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
              <path d={svgPaths.p11d57a00} stroke={currentPage === "redemption" ? "white" : "#D1D5DC"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
            </svg>
          ...
          >
            <svg className="size-[20px]" fill="none" viewBox="0 0 20 20">
              ...
              <g clipPath="url(#clip0)">
                <path d={svgPaths.p363df2c0} stroke={currentPage === "monitoring" ? "white" : "#D1D5DC"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
              </g>
            </svg>
      ...
      <div className="fixed left-0 right-0 top-0 z-10 flex h-[64px] items-center justify-between bg-[#155dfc] px-[32px]">
        ...
        <div className="flex items-center gap-[12px]">
          <button className="rounded-[10px] px-[16px] py-[8px] text-white transition-colors hover:bg-white/10">관리자: 홍길동</button>
          <button className="rounded-[10px] bg-white px-[20px] py-[8px] text-[#155dfc] transition-colors hover:bg-gray-100">로그아웃</button>
        </div>
      </div>
