          ...
          <div className="space-y-[16px]">
            ...
            <div className="space-y-[10px]">
              <div className="flex items-center justify-between border-b border-gray-100 py-[12px]">
                <div className="flex items-center gap-[8px]">
                  <div className="size-[8px] rounded-full bg-[#00c950]"></div>
              ...
              <div className="flex items-center justify-between border-b border-gray-100 py-[12px]">
                <div className="flex items-center gap-[8px]">
                  <div className="size-[8px] rounded-full bg-[#fb2c36]"></div>
              ...
              <div className="flex items-center justify-between border-b border-gray-100 py-[12px]">
                <div className="flex items-center gap-[8px]">
                  <div className="size-[8px] rounded-full bg-[#2b7fff]"></div>
              ...
              <div className="flex items-center justify-between border-b border-gray-100 py-[12px]">
                <div className="flex items-center gap-[8px]">
                  <div className="size-[8px] rounded-full bg-[#ad46ff]"></div>
